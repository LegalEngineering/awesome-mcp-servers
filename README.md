...
- [LegalEngineering/sk-registers-mcp](https://github.com/LegalEngineering/sk-registers-mcp) 🐍 ☁️ - Access Slovakia's central reference register (RPO) aggregating 100+ source registers. Query 1.4M+ legal entities, entrepreneurs, and public authorities by name, Identification number, or municipality.
